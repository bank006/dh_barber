...
import {
  ...
  useUnmountEffect,
  useUpdateEffect
} from "./chunk-ZO5G4EWG.js";
import "./chunk-T4OQEYPM.js";
...
var EyeIcon = React2.memo(React2.forwardRef(function(inProps, ref) {
...
var RefreshIcon = React3.memo(React3.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var SearchMinusIcon = React4.memo(React4.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var SearchPlusIcon = React5.memo(React5.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var UndoIcon = React7.memo(React7.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var DownloadIcon = React8.memo(React8.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var Image = React8.memo(React8.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React8.useContext(PrimeReactContext);
  var props = ImageBase.getProps(inProps, context);
  var _React$useState = React8.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), maskVisibleState = _React$useState2[0], setMaskVisibleState = _React$useState2[1];
  var _React$useState3 = React8.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), previewVisibleState = _React$useState4[0], setPreviewVisibleState = _React$useState4[1];
  var _React$useState5 = React8.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), rotateState = _React$useState6[0], setRotateState = _React$useState6[1];
  var _React$useState7 = React8.useState(1), _React$useState8 = _slicedToArray(_React$useState7, 2), scaleState = _React$useState8[0], setScaleState = _React$useState8[1];
  var elementRef = React8.useRef(null);
  var imageRef = React8.useRef(null);
  var maskRef = React8.useRef(null);
  var previewRef = React8.useRef(null);
  var previewButton = React8.useRef(null);
  ...
  var createPreview = function createPreview2() {
    ...
    if (props.preview) {
      return React8.createElement("button", buttonProps, content);
    }
    return null;
  };
  var createElement9 = function createElement10() {
    ...
    var downloadIcon = IconUtils.getJSXIcon(props.downloadIcon || React8.createElement(DownloadIcon, null), _objectSpread2({}, downloadIconProps), {
      props
    });
    var rotateRightIcon = IconUtils.getJSXIcon(props.rotateRightIcon || React8.createElement(RefreshIcon, null), _objectSpread2({}, rotateRightIconProps), {
      props
    });
    var rotateLeftIcon = IconUtils.getJSXIcon(props.rotateLeftIcon || React8.createElement(UndoIcon, null), _objectSpread2({}, rotateLeftIconProps), {
      props
    });
    var zoomOutIcon = IconUtils.getJSXIcon(props.zoomOutIcon || React8.createElement(SearchMinusIcon, null), _objectSpread2({}, zoomOutIconProps), {
      props
    });
    var zoomInIcon = IconUtils.getJSXIcon(props.zoomInIcon || React8.createElement(SearchPlusIcon, null), _objectSpread2({}, zoomInIconProps), {
      props
    });
    var closeIcon = IconUtils.getJSXIcon(props.closeIcon || React8.createElement(TimesIcon, null), _objectSpread2({}, closeIconProps), {
      props
    });
    ...
    return React8.createElement("div", maskProps, React8.createElement("div", toolbarProps, downloadable && React8.createElement("button", downloadButtonProps, downloadIcon), React8.createElement("button", rotateRightButtonProps, rotateRightIcon), React8.createElement("button", rotateLeftButtonProps, rotateLeftIcon), React8.createElement("button", zoomOutButtonProps, zoomOutIcon), React8.createElement("button", zoomInButtonProps, zoomInIcon), React8.createElement("button", closeButtonProps, closeIcon)), React8.createElement(CSSTransition, _extends7({
      nodeRef: previewRef
    }, transitionProps), React8.createElement("div", previewContainerProps, React8.createElement("img", _extends7({
      alt: alt2
    }, previewProps)))));
  };
  ...
  var icon = props.indicatorIcon || React8.createElement(EyeIcon, iconProp);
  ...
  var image = props.src && React8.createElement("img", _extends7({}, imageProp, {
    alt
  }));
  ...
  return React8.createElement("span", rootProps, image, preview2, maskVisibleState && React8.createElement(Portal, {
    element,
